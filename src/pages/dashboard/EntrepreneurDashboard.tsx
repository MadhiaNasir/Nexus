...
export const EntrepreneurDashboard: React.FC = () => {
  ...
  const [calendarEvents, setCalendarEvents] = useState([
    {
      id: "1",
      title: "Confirmed: Investor Pitch Meet",
      date: "2026-07-12",
      color: "#16a34a",
    },
    {
      id: "2",
      title: "Availability Slot (Open)",
      date: "2026-07-16",
      color: "#4f46e5",
    },
  ]);
  ...
  const handleAddSlot = () => {
    const slotDate = prompt(
      "Enter availability slot date (YYYY-MM-DD):",
      "2026-07-20",
    );
  ...
  const handleAcceptMeeting = (id: string, name: string, date: string) => {
    setCalendarEvents((prev) => [
      ...
      {
        id: Date.now().toString(),
        title: `Confirmed: Meet with ${name}`,
        date: date,
        color: "#16a34a",
      },
    ]);
              ...
              {pendingMeetings.length > 0 ? (
                <div className="space-y-3">
                  {pendingMeetings.map((m) => (
                    <div
                      key={m.id}
                      className="flex justify-between items-center p-3 border border-gray-100 rounded-lg bg-gray-50/50"
                    >
                      <div>
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={() =>
                            handleAcceptMeeting(m.id, m.investorName, m.date)
                          }
                        >
                          Accept
                        </Button>
          ...
          <Card>
            <CardHeader className="flex justify-between items-center">
              <h2 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                <CalendarIcon size={18} className="text-primary-600" /> Schedule
