...
export const PaymentsPage: React.FC = () => {
  ...
  const transactions = [
    ...
    },
    {
      ...
      type: "Funding Deal",
      amount: "$35,250",
      sender: "Investor Capital",
      receiver: "Startup Escrow",
      status: "Secured",
      date: "2026-07-04",
    },
  ];
    ...
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">
          Wallet & Payments Chamber
        </h1>
        <p className="text-gray-650">
          Simulate secure fund transfers and track investment escrow flows
        </p>
      </div>
          ...
          <CardBody className="space-y-4">
            ...
            <div className="flex gap-2 pt-2">
              <Button
                ...
                onClick={() => alert("Deposit simulation...")}
              >
                Deposit
              </Button>
              <Button
                ...
                variant="outline"
                className="border-white/30 text-white hover:bg-white/10"
                onClick={() => alert("Withdraw simulation...")}
              >
                Withdraw
              </Button>
            </div>
      ...
      <Card>
        <CardHeader>
          <h2 className="text-lg font-medium text-gray-900 flex items-center gap-2">
            <RefreshCcw size={18} className="text-blue-600" /> Transaction
            Ledger History
          </h2>
        </CardHeader>
        <CardBody>
