...
// Strictly map matching variant string configurations accepted by your Badge component layout type schemas
type BadgeVariant =
  | "default"
  | "secondary"
  | "success"
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Track and manage your investment pipeline & secure transactions
          </p>
        </div>

        <Button
          onClick={() => alert("Creating custom investment intent frame...")}
        >
          Add Deal
        </Button>
      </div>
                    ...
                    <tr key={deal.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            alert("Loading audit document metadata...")
                          }
                        >
                          Details
                        </Button>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <Button
                        ...
                        onClick={() =>
                          alert(
                            `Downloading official PDF cryptographically sealed invoice receipt for ${inv.id}`,
                          )
                        }
                      >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="border border-gray-300 rounded-lg px-3 py-2 bg-white text-sm font-mono">
                      12 / 29
                    </div>
                  </div>
                  <div>
              ...
              <div className="pt-4">
                <Button
                  variant="primary"
                  fullWidth
                  className="bg-blue-600 hover:bg-blue-700 py-2.5 text-sm font-bold shadow-md flex justify-center items-center gap-2"
                  onClick={processStripePayment}
                  disabled={isProcessing}
                >
                  {isProcessing ? (
                    <span>Authorizing Escrow Token...</span>
                  ) : (
                    <>
                      <ShieldCheck size={16} />
                      <span>Authorize Payment ({activeDeal.amount})</span>
                    </>
                  )}
                </Button>
                <p className="text-[11px] text-gray-400 text-center mt-2.5">
                  Secured by Stripe. Funds will be held in encrypted compliance
                  escrow vault layers.
                </p>
              </div>
            </div>
